...
class _MsgIdEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MsgId.ValueType], builtins.type):
    ...
    MSG_PING_CMD: _MsgId.ValueType  # 1
    """Simple PING to see if the node is alive"""
    MSG_TERMINAL: _MsgId.ValueType  # 2
    """Terminal command for printing text/debug data"""
    MSG_SYS_TICK: _MsgId.ValueType  # 3
    """System time tick"""
    MSG_SYS_INFO: _MsgId.ValueType  # 4
    """System information"""
    MSG_PARAM_IO: _MsgId.ValueType  # 5
    """Do operations on configurable parameters"""
    MSG_SYS_CTRL: _MsgId.ValueType  # 6
    """Perform system control operations"""
    MSG_SYS_DATA: _MsgId.ValueType  # 7
    """System data stream"""
...
class _StatusCodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_StatusCode.ValueType], builtins.type):
    ...
    INVALID_PARAM: _StatusCode.ValueType  # 2
    INVALID_TYPE: _StatusCode.ValueType  # 3
    INVALID_VALUE: _StatusCode.ValueType  # 4
    REQUEST_FAILED: _StatusCode.ValueType  # 5
...
class AckNackMessage(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        status_code: global___StatusCode.ValueType | None = ...,
