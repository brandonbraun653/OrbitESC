...
_SUBID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SUB_MSG_SYS_CTRL_MOTOR', index=5, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SUB_MSG_SYS_CTRL_CAL_ADC', index=6, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
SUB_MSG_SYS_CTRL_MOTOR = 1
SUB_MSG_SYS_CTRL_CAL_ADC = 2
PARAM_INVALID = -1
PARAM_BOOT_COUNT = 0
PARAM_HW_VERSION = 1
PARAM_SW_VERSION = 2
...
_SYSTEMDATAMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_SYSTEMDATAMESSAGE_ADCPHASECURRENTS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
