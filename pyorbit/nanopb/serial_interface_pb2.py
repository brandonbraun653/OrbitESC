...
_SYSTEMDATAMESSAGE_ADCSYSTEMMEASUREMENTS = _descriptor.Descriptor(
  name='ADCSystemMeasurements',
  full_name='SystemDataMessage.ADCSystemMeasurements',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='SystemDataMessage.ADCSystemMeasurements.timestamp', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='v_mcu', full_name='SystemDataMessage.ADCSystemMeasurements.v_mcu', index=1,
      number=2, type=2, cpp_type=6, label=2,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='v_dc_link', full_name='SystemDataMessage.ADCSystemMeasurements.v_dc_link', index=2,
      number=3, type=2, cpp_type=6, label=2,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='v_temp', full_name='SystemDataMessage.ADCSystemMeasurements.v_temp', index=3,
      number=4, type=2, cpp_type=6, label=2,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='v_isense', full_name='SystemDataMessage.ADCSystemMeasurements.v_isense', index=4,
...
_SYSTEMDATAMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_SYSTEMDATAMESSAGE_ADCPHASECURRENTS, _SYSTEMDATAMESSAGE_ADCSYSTEMMEASUREMENTS, _SYSTEMDATAMESSAGE_ADCPHASEVOLTAGES, _SYSTEMDATAMESSAGE_STATEESTIMATES, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SYSTEMDATAMESSAGE_ADCSYSTEMMEASUREMENTS.containing_type = _SYSTEMDATAMESSAGE
...
SystemDataMessage = _reflection.GeneratedProtocolMessageType('SystemDataMessage', (_message.Message,), {
  ...
  'ADCSystemMeasurements' : _reflection.GeneratedProtocolMessageType('ADCSystemMeasurements', (_message.Message,), {
    'DESCRIPTOR' : _SYSTEMDATAMESSAGE_ADCSYSTEMMEASUREMENTS,
    '__module__' : 'serial_interface_pb2'
    # @@protoc_insertion_point(class_scope:SystemDataMessage.ADCSystemMeasurements)
    })
  ,
...
_sym_db.RegisterMessage(SystemDataMessage.ADCSystemMeasurements)
