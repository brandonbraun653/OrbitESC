...
typedef enum _MsgId {
    ...
    MsgId_MSG_STREAM_REQ = 9 /* Request a data stream behavior from the device */
} MsgId;
...
#define _MsgId_MAX MsgId_MSG_STREAM_REQ
#define _MsgId_ARRAYSIZE ((MsgId)(MsgId_MSG_STREAM_REQ+1))
...
struct MessageDescriptor<Header> {
    ...
    static PB_INLINE_CONSTEXPR const pb_size_t size = Header_size;
...
struct MessageDescriptor<BaseMessage> {
    ...
    static PB_INLINE_CONSTEXPR const pb_size_t size = BaseMessage_size;
    static inline const pb_msgdesc_t* fields() {
...
struct MessageDescriptor<AckNackMessage> {
    ...
    static PB_INLINE_CONSTEXPR const pb_size_t size = AckNackMessage_size;
    static inline const pb_msgdesc_t* fields() {
...
struct MessageDescriptor<PingMessage> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_size_t size = PingMessage_size;
    static inline const pb_msgdesc_t* fields() {
