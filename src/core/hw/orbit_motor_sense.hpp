...
namespace Orbit::Motor::Sense
{
  ...
  enum ChannelSequence : uint8_t
  {
    ...
    CHANNEL_VOLTAGE_START = CHANNEL_PHASE_A_VOLTAGE,
    CHANNEL_VOLTAGE_END   = CHANNEL_PHASE_C_VOLTAGE,
    CHANNEL_CURRENT_START = CHANNEL_PHASE_A_CURRENT,
    CHANNEL_CURRENT_END   = CHANNEL_PHASE_C_CURRENT,
  };
