...
namespace Orbit::IO
{
  ...
  namespace Digital
  {
    ...
    static constexpr Chimera::GPIO::Pin     ledOEPin     = 14;
    static constexpr Chimera::GPIO::Port    ledOEPort    = Chimera::GPIO::Port::PORTC;
    static constexpr Chimera::GPIO::PinInit ledOEPinInit = { .alternate = Chimera::GPIO::Alternate::NONE,
